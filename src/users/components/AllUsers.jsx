...
import { Table, TableBody, TableCell, TableContainer, TableHead, TableRow, Paper, IconButton, TextField, Button, Typography } from "@mui/material";
...
const AllUsers = ({
    ...
    return (
        <>
            ...
            <Typography>*לא ניתן למחוק משתמש עם ספרים מושאלים. משתמש לא יכול למחוק את עצמו</Typography>
        </>
    );
};
